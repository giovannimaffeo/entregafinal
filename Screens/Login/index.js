...
export default function Login() {
  return (
    <View style={styles.container}>
        <Text style={styles.principal}>SISTEMA DE LOGIN</Text>

        <TextInput style={styles.username} placeholder="Digite seu username"/>
        <TextInput secureTextEntry={true} style={styles.senha} placeholder="Digite sua senha"/>
